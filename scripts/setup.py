...
def install_gem_components(components):
    """Install components using gem."""
    if components is not None:
        print("Installing gem components...")
        component_list = " ".join(components)
        run_command(f"gem install {component_list}")
    else:
        print("No gem components to install.")
...
if __name__ == "__main__":
    ...
    try:
        ...
        gem_components = build_requirements.get("gem", [])
